...
export class Solicitudes implements OnInit{
  ...
  ngOnInit(){
    ...
    Promise.all([this.service.getSolicitudesHabilidad().toPromise(),this.service.getSolicitudesCategorias().toPromise(),this.service.getCategorias().toPromise()])
      .then(([sh,sc,c]:any[])=>{
  ...
  responder(){
    ...
    const obs=this.tab==='habilidades'
      ?this.service.responderHabilidad(this.solSel.id,{estado,comentario,categoriaId})
      :this.service.responderCategoria(this.solSel.id,{estado,comentario});
